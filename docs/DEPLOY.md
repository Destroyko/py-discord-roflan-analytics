...
- [ ] **Не** дублировать scheduler: monthly job уже внутри бота (1-е число в `LEADERBOARD_MONTHLY_RUN_HOUR`:`LEADERBOARD_MONTHLY_RUN_MINUTE`, TZ `LEADERBOARD_TIMEZONE`, по умолчанию 10:00 МСК)
...
| Сервис упал **во время** скана | Restart сервиса, затем `bot.cli run … --resume` |
